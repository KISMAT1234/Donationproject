...
// ************** FAVOURITE *****************
  ...
  return (
    ...
    <div className="relative w-full ml-5">
      <div className="overflow-x-auto whitespace-nowrap no-scrollbar fixed z-10 top-14 md:top-20 px-2 py-2 md:w-[75%] w-[94%] rounded-2xl bg-stone-100 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
        <div className="inline-flex space-x-2">
          <div className="flex-shrink-0 ml-1 my-1 px-4 py-2 rounded-2xl bg-green-400 hover:bg-indigo-600 hover:text-white border-2 border-indigo-400 hover:border-indigo-800 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
            <Link to="/Mainpage">
          ...
          <div className="flex-shrink-0 ml-1 my-1 px-4 py-2 rounded-2xl bg-green-400 hover:bg-indigo-600 hover:text-white border-2 border-indigo-400 hover:border-indigo-800 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
            <Link to="">
              <h1 className="text-xl">Disease</h1>
            </Link>
          </div>

          <div className="flex-shrink-0 ml-1 my-1 px-4 py-2 rounded-2xl bg-green-400 hover:bg-indigo-600 hover:text-white border-2 border-indigo-400 hover:border-indigo-800 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
            <Link to="">
              <h1 className="text-xl">Animal</h1>
            </Link>
          </div>
          ...
          <div className="flex-shrink-0 ml-1 my-1 px-4 py-2 rounded-2xl bg-green-400 hover:bg-indigo-600 hover:text-white border-2 border-indigo-400 hover:border-indigo-800 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]">
            <Link to="/Mainpage/search?category=Orphange">
              <h1 className="text-xl">Orphange</h1>
            </Link>
          </div>
